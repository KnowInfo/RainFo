import { DomMeta, DomNode } from "../../types";
import { CAMEL_DATASET_IDENTIFIER, ROOT_IDX, UNKOWN_IDX } from "../../util/const";
/**
...
const getTextPreOffset = ($root: Node, $text: Node): number => {
  ...
  let $curNode: Node | undefined | null = null;
  let offset = 0;
